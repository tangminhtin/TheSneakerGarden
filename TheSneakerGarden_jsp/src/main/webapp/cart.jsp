                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-10">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="./shop.jsp">
                                <button type="button" class="btn btn-lg" style="background: #ff7c03; color: #fff">Go to
                                    shopping</button>
                            </a>
                        </div>
                                ...
                                <div class="card-body p-4" style="background-color: #eee;">
                                    <div class="row d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                            <button class="btn btn-link px-2" onclick="onMinusProduct(this)">
                                ...
                                <div class="card-body">
                                    <a href="./checkout.jsp">
                                        <button type="button" class="btn btn-block btn-lg"
                                                style="background: #ff7c03; color: #fff">Proceed to
                                            Pay</button>
                                    </a>
                                </div>
                            </div>
